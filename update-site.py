...
بيعمل الأربع خطوات دفعة واحدة بالترتيب الصحيح:
  ...
  3) يتأكد إن كود Google Analytics مضاف في أي صفحة جديدة
  4) يدرج ودجت المشاركة (Share) في أي أداة أو مقال جديد لسه ما عندهوش
...
STEPS = [
    ...
    ("التأكد من كود Google Analytics في كل الصفحات", "add-google-analytics.py"),
    ("إضافة ودجت المشاركة للصفحات الجديدة", "add-share-widget.py"),
]
